...
// {
//     const cityAsked=document.getElementById("field").value;
//     const api=`https://pl.wikipedia.org//w/api.php?action=query&format=json&titles=${cityAsked}&origin=*&prop=revisions&rvprop=content`;
//     console.log(api);
//     fetch(api)
//         .then(res => res.json())
//         .then(data => {
